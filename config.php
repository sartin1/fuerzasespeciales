...
define('FS_DB_HOST', 'mysql.hostinger.com.ar');
define('FS_DB_PORT', '3306'); /// MYSQL -> 3306, POSTGRESQL -> 5432
define('FS_DB_NAME', 'u709605270_comte');
define('FS_DB_USER', 'u709605270_comte'); /// MYSQL -> root, POSTGRESQL -> postgres
define('FS_DB_PASS', 'richard!');

/*
 * Un directorio de nombre aleatorio para mejorar la seguridad del directorio temporal.
 */
define('FS_TMP_NAME', '0VCNhfWTxEk2qlGFmgY4/');
 ...
 * Sartin conectadas al mismo servidor memcache.
 */

define('FS_CACHE_HOST', 'localhost');
define('FS_CACHE_PORT', '11211');
define('FS_CACHE_PREFIX', 'nT4Wiaxj_');
