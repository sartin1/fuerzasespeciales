                           ...
                           <div class="col-sm-4">
                              <div class="form-group">
                                 <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" name="mail_bcc" value="<?php echo $fsc->empresa->email_config['mail_bcc'];?>" placeholder="Enviar copias a"/>
                                 </div>
                              ...
                              <div class="col-sm-3">
                                 <div class="form-group">
                                    ...
                                    <select name="mail_enc" class="form-control">
                                       ...
                                       <option value="tls"<?php if( $fsc->empresa->email_config['mail_enc']=='tls' ){ ?> selected=""<?php } ?>>TLS</option>
                                       <option value="">---</option>
                                       <option value=""<?php if( $fsc->empresa->email_config['mail_enc']=='' ){ ?> selected=""<?php } ?>>Ninguna</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                     ...
                     <div class="container-fluid">
                        <div class="row">
                           <div class="col-sm-12">
                              ...
                              <p class='help-block'>
                                 Esto es lo que va a salir en el final de todos tus mails
                              </p>
