...
class admin_agentes extends fs_controller
{
   ...
   {
      parent::__construct(__CLASS__, 'Efectivos policiales', 'admin', TRUE, TRUE);
   }
   ...
   protected function private_core()
   {
      ...
      if( isset($_POST['sdnicif']) )
      {
         ...
         if( $age0->save() )
         {
            $this->new_message("Efectivo policial ".$age0->codagente." guardado correctamente.");
            header('location: '.$age0->url());
         }
         else
            $this->new_error_msg("¡Imposible guardar el Efectivo policial!");
      }
      else if( isset($_GET['delete']) )
      {
         ...
         if($age0)
         {
            ...
            {
               $this->new_message("Efectivo policial ".$age0->codagente." eliminado correctamente.");
            }
            else
               $this->new_error_msg("¡Imposible eliminar el Efectivo policial!");
         }
         else
